...
function Link(props) {
  ...
  return (
    <Draggable draggableId={props.link.id} index={props.link.current_position}>
      {provided => (
        <div 
        ...
        class="group7">
          ...
          {groupEditDelete ? (
            <div id="group-edit-del">
              <div>
                <button class="group-edit-del-btn" onClick={editLinkHendler}>
                  edit
                </button>
              </div>
              <div>
                <button
                  class="group-edit-del-btn"
                  onClick={() => {
                    deleteLinkHendler(props.link.id);
                  }}
                >
                  delete
                </button>
